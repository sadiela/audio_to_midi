...
def encode_midi(file_path):
    ...
    cur_vel = 0
    for snote in dnotes:
        events += _make_time_shift_events(prev_time=cur_time, post_time=snote.time)
...
if __name__ == '__main__':
    mid = '/Users/sadiela/Documents/phd/research/music/genre_study/data/MIDI_snippets/all_MIDIs/punk/5f314b18a131516da05c1fc83d91051e.mid'
    prepped = encode_midi(mid)
    decoded = decode_midi(prepped)
